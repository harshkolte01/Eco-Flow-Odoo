        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-600 max-w-md text-sm leading-relaxed">
              Streamlining your workflow with intelligent automation and real-time insights.
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/analytics" className="text-sm text-gray-600 hover:text-emerald-600 transition-colors">
                  Analytics
                </Link>
              </li>
              <li>
                <Link href="/reports" className="text-sm text-gray-600 hover:text-emerald-600 transition-colors">
                  Reports
                </Link>
              </li>
              <li>
                <Link href="/settings" className="text-sm text-gray-600 hover:text-emerald-600 transition-colors">
                  Settings
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">
              © {currentYear} ECOFlow. All rights reserved.
            </p>
